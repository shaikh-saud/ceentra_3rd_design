...
const FOOTER_LINKS = [
  {
    title: "الدعم",
    links: [
      { id: 1, title: "مركز المساعدة", url: "/#help" },
      { id: 2, title: "تواصل معنا", url: "/contact" },
      { id: 3, title: "الأسئلة الشائعة", url: "/faq" },
      { id: 4, title: "الشروط والأحكام", url: "/terms" },
    ],
  },
  {
    title: "انضم إلينا",
    links: [
      { id: 5, title: "انضم كمستشار", url: "/consultant/apply" },
      { id: 6, title: "انضم كمدرب", url: "/trainer/apply" },
      { id: 7, title: "انضم كصانع محتوى", url: "/visual-production/join" },
      { id: 8, title: "إنشاء حساب", url: "/register" },
      { id: 9, title: "كيفية العمل", url: "/how-it-works" },
    ],
  },
  {
    title: "للشركات",
    links: [
      { id: 10, title: "تسجيل شركة", url: "/register" },
      { id: 11, title: "توثيق الشركة", url: "/verify-company" },
      { id: 12, title: "تسجيل دخول الشركات", url: "/login" },
      { id: 13, title: "الأسعار", url: "/subscriptions" },
    ],
  },
  {
    title: "روابط سريعة",
    links: [
      ...
      { id: 15, title: "كيف تعمل المنصة؟", url: "/how-it-works" },
      { id: 16, title: "الطلبات", url: "/jobs" },
