...
export default function SolutionAds() {
  ...
  return (
    <section
      ref={ref}
      className="py-12 sm:py-16 md:py-20 bg-white lg:sticky lg:top-0 lg:z-2 lg:h-screen lg:flex lg:items-center lg:py-0 lg:shadow-[0_-30px_80px_rgba(0,0,0,0.15)]"
    >
        ...
        <div className="flex flex-col lg:flex-row-reverse items-center gap-8 sm:gap-10 md:gap-12 lg:gap-16">
          ...
          <div className="flex-1 text-center lg:text-right order-2 lg:order-1">
            ...
            <motion.div
              ...
              animate={isInView ? "visible" : "hidden"}
              custom={0.12}
              className="text-[13px] sm:text-[14px] md:text-[15px] lg:text-[16px] text-text-secondary leading-[1.8] mb-4 sm:mb-5 md:mb-6 max-w-lg mx-auto lg:mx-0"
            >
              <p>الإعلانات مو مجرد ميزانية.</p>
              <p>الإعلانات استراتيجية.</p>
              <p className="font-semibold text-text-primary mt-2">
                نستهدف العملاء المناسبين، ونبني حملات تحقق نتائج.
              </p>
            </motion.div>
            ...
            <motion.div
              ...
              animate={isInView ? "visible" : "hidden"}
              custom={0.18}
              className="flex items-center justify-center lg:justify-start gap-2 sm:gap-3 mb-5 sm:mb-6 md:mb-7"
            >
              <span className="px-3 sm:px-4 py-1.5 sm:py-2 rounded-full bg-blue-50 text-blue-600 text-[11px] sm:text-[13px] font-semibold border border-blue-100">
                Google Ads
              </span>
              <span className="px-3 sm:px-4 py-1.5 sm:py-2 rounded-full bg-indigo-50 text-indigo-600 text-[11px] sm:text-[13px] font-semibold border border-indigo-100">
                Meta Ads
              </span>
            </motion.div>
