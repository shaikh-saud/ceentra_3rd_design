...
import { CreditCard, ChevronRight, CheckCircle, Clock, Wallet } from "lucide-react";
...
const STATS = [
  { title:"الإجمالي",  value:"0", icon:Wallet,       gradient:"from-[#0e2453] to-[#1a3a7a]", change:"—", changeStyle:"plain" as const },
...
const COLS = ["رقم العملية", "النوع", "الإجمالي", "الحالة"];

export default function ClientPaymentsContent({ onBack }: Props) {
  return (
    <div className="max-w-[1400px] mx-auto space-y-6 animate-[fadeSlideUp_0.45s_ease-out]">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          <div className="flex items-center gap-3 mb-1.5">
            ...
            <h1 className="text-[24px] font-extrabold text-[#0e2453] leading-tight">المدفوعات</h1>
          </div>
          <p className="text-[13px] text-[#0e2453]/50 font-medium">سجل مدفوعاتك وحالاتها وإجمالي الحركات.</p>
        </div>
      ...
      <TableCard
        toolbar={
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <p className="text-[14px] font-extrabold text-[#0e2453] leading-none">المدفوعات</p>
      ...
      >
        ...
        <EmptyState
          ...
          subtitle="ستظهر هنا جميع عمليات الدفع بعد إتمامها."
        />
