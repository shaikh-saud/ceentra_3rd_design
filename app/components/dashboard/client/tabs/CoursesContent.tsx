...
const STATS = [
  { title:"الدورات المسجلة", value:"0", icon:BookOpen,     gradient:"from-[#0e2453] to-[#1a3a7a]", change:"—", changeStyle:"plain" as const },
  { title:"المكتملة",         value:"0", icon:CheckCircle,  gradient:"from-[#058B7F] to-[#0FAE9E]", change:"—", changeStyle:"plain" as const },
  { title:"النشطة",           value:"0", icon:Play,         gradient:"from-[#b45309] to-[#d97706]", change:"—", changeStyle:"plain" as const },
];

const COLS = ["الكورس", "التقدم", "الحالة"];

export default function ClientCoursesContent({ onBack }: Props) {
  return (
        ...
        <div>
          <div className="flex items-center gap-3 mb-1.5">
            <div className="w-9 h-9 rounded-xl bg-[#058B7F]/10 flex items-center justify-center shrink-0">
              <BookOpen className="w-4 h-4 text-[#058B7F]" />
            </div>
            <h1 className="text-[24px] font-extrabold text-[#0e2453] leading-tight">الدورات والتدريب</h1>
          </div>
          <p className="text-[13px] text-[#0e2453]/50 font-medium">إدارة دوراتك المسجلة وتقدمك في التعلم.</p>
        </div>
      ...
      <TableCard
        toolbar={
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <p className="text-[14px] font-extrabold text-[#0e2453] leading-none">الدورات والتدريب</p>
              <p className="text-[11px] text-[#0e2453]/40 font-medium mt-0.5">0 دورة</p>
            </div>
          </div>
        }
      >
        ...
        <div className="hidden lg:block overflow-x-auto">
          ...
          <div className="pb-4">
            <EmptyState
              ...
              subtitle="تصفح الدورات المتاحة وابدأ رحلتك التعليمية الآن."
            />
