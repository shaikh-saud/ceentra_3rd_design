...
import { ShoppingBag, ChevronRight, DollarSign, ShoppingCart } from "lucide-react";
...
const STATS = [
  { title:"المشتريات",     value:"0",     icon:ShoppingBag, gradient:"from-[#0e2453] to-[#1a3a7a]", change:"—", changeStyle:"plain" as const },
  { title:"إجمالي الصرف", value:"0 SAR", icon:DollarSign,  gradient:"from-[#058B7F] to-[#0FAE9E]", change:"—", changeStyle:"plain" as const },
];

const COLS = ["العملية", "النوع", "المبلغ"];

export default function ClientPurchasesContent({ onBack }: Props) {
  return (
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          <div className="flex items-center gap-3 mb-1.5">
            ...
            <h1 className="text-[24px] font-extrabold text-[#0e2453] leading-tight">المشتريات</h1>
          </div>
          <p className="text-[13px] text-[#0e2453]/50 font-medium">آخر المشتريات المكتملة والخدمات التي دفعتها.</p>
        </div>
      ...
      <TableCard
        toolbar={
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <p className="text-[14px] font-extrabold text-[#0e2453] leading-none">المشتريات</p>
              <p className="text-[11px] text-[#0e2453]/40 font-medium mt-0.5">0 عملية</p>
            </div>
          </div>
        }
      >
        ...
        <EmptyState
          icon={ShoppingCart}
          title="لا توجد مشتريات مكتملة حتى الآن."
          subtitle="بعد إتمام أول عملية شراء ستظهر هنا تلقائياً."
        />
