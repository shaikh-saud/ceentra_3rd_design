...
import { NAVY, SIDEBAR_ITEMS } from "../constants";
  ...
  return (
    <>
      ...
      >
        ...
        {/* Nav Items */}
        <nav className="flex-1 overflow-y-auto px-3 pb-4 space-y-0.5 [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]">
        ...
        <div className="px-4 pb-6 pt-2 border-t border-white/[0.06]">
          <button className="w-full flex items-center gap-3 px-4 py-3 rounded-xl text-[13px] font-bold text-white/40 hover:text-red-400 hover:bg-red-500/10 transition-all">
