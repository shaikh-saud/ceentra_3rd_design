      ...
      >
        ...
        <div className="container relative z-10 mx-auto px-4 text-center">
          ...
          <p className="text-white/80 text-[16px] md:text-lg max-w-2xl mx-auto leading-relaxed">
            شارك خبرتك وساعد الآخرين في تطوير أعمالهم، وابدأ بتقديم استشاراتك المتقدمة لآلاف المشاريع والشركات الناشئة.
          </p>
        </div>
      </div>
        ...
        <div className="container relative z-10 mx-auto px-4 max-w-4xl">
            ...
            <form onSubmit={(e) => e.preventDefault()} className="space-y-12">
                  ...
                  <div className="space-y-1.5 min-w-0">
                    ...
                    <div className="relative flex items-center">
                      ...
                      <select className="w-full h-13 bg-gray-50/50 border border-gray-200 rounded-xl pr-11 pl-4 text-[14px] text-[#0e2453] outline-none transition-all focus:border-[#058B7F] focus:bg-white focus:ring-4 focus:ring-[#058B7F]/10 appearance-none">
                        ...
                        <option value="marketing">التسويق الاستراتيجي</option>
              ...
              <section>
                ...
                <div className="grid md:grid-cols-2 gap-6 mb-6">
                  ...
                  <div className="space-y-1.5">
                    <div className="flex items-center justify-between">
                      <label className="text-[13px] font-bold text-[#0e2453] px-1">سعر الساعة (ر.س) <span className="text-[#058B7F]">*</span></label>
                      <span className="text-[10px] text-[#0e2453]/40 px-1 font-medium bg-gray-50 rounded">الحد الأدنى 100 ر.س - الحد الأقصى 5000 ر.س</span>
                    </div>
                    <div className="relative flex items-center">
                ...
                <div className="space-y-1.5">
                  <div className="flex flex-wrap items-center justify-between mb-1">
                    ...
                    <span className="text-[10px] text-[#0e2453]/40 px-1 font-medium bg-gray-50 rounded">الحد الأدنى 50 حرف - الحد الأقصى 2000 حرف</span>
                  </div>
                  <textarea 
                    placeholder="اكتب نبذة مختصرة عن خبراتك ومؤهلاتك (50 حرف على الأقل)"
                    rows={5}
              ...
              <section>
                <div className="flex items-center gap-3 mb-6 pb-4 border-b border-gray-100">
                  ...
                  <h2 className="text-xl font-bold text-[#0e2453]">المستندات</h2>
                </div>

                <div className="grid md:grid-cols-2 gap-6">
                  {/* CV Upload */}
                  <div className="space-y-1.5">
                    <label className="text-[13px] font-bold text-[#0e2453] px-1">السيرة الذاتية (CV) <span className="text-[#058B7F]">*</span></label>
                    <div 
                    ...
                    >
                      ...
                      {cvFile ? (
                        ...
                        <div className="text-center">
                          <h4 className="font-bold text-[#0e2453] text-[13px] mb-1">السيرة الذاتية (PDF / Word)</h4>
                          <span className="mt-1 inline-block text-[10px] bg-red-100 text-red-600 px-2 py-0.5 rounded font-medium tracking-wide">No file chosen</span>
                        </div>
                      )}
                    </div>
                  </div>
                  ...
                  {/* Certs Upload */}
                  <div className="space-y-1.5">
                    <label className="text-[13px] font-bold text-[#0e2453] px-1">الشهادات والمؤهلات <span className="text-[#0e2453]/40 font-normal">(اختياري)</span></label>
                    <div 
                    ...
                    >
                      ...
                      {certFiles.length > 0 ? (
                        ...
                        <div className="text-center">
                          <h4 className="font-bold text-[#0e2453] text-[13px] mb-1">شهادات أو أوراق رسمية</h4>
                          <span className="mt-1 inline-block text-[10px] bg-red-100 text-red-600 px-2 py-0.5 rounded font-medium tracking-wide">No file chosen</span>
                        </div>
                      )}
                    </div>
          ...
          <div className="bg-[#0e2453]/[0.02] border border-[#0e2453]/10 rounded-[24px] p-8 mt-10">
            ...
            <ul className="grid sm:grid-cols-2 gap-3 pl-2">
              {[
                "سيتم مراجعة طلبك بدقة خلال 2-3 أيام عمل.",
                "سيتم التواصل معك عبر البريد الإلكتروني للمتابعة والإفادة.",
                "يرجى التأكد من صحة ودقة جميع البيانات والمستندات المدخلة.",
                "كلمة المرور الافتراضية الخاصة بك بعد قبول طلبك: password123"
              ].map((note, i) => (
